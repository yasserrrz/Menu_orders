...
export default function Waiter() {
    ...
    let {waiterList } = useContext(OrderContext);
     let {t} = useTranslation();

     const [currentList, setCurrentList] = useState(waiterList);
    ...
    //  const updateLists = () => {
    //   const redList = waiterList.filter((ele) => {
    ...
    //   const greenList = waiterList.filter((ele) => {
    //     const specificTime = new Date(ele.createDate);
    //     const currentTime = new Date();
    //     const timePassedInSeconds = Math.floor(
    //       (currentTime.getTime() - specificTime.getTime()) / 1000
    ...
    //   const yellowList = waiterList.filter((ele) => {
    //     const specificTime = new Date(ele.createDate);
    //     const currentTime = new Date();
    //     const timePassedInSeconds = Math.floor(
    //       (currentTime.getTime() - specificTime.getTime()) / 1000
    ...
    const updateLists = () => {
      const redList = waiterList.filter((ele, index, array) => {
      ...
      const greenList = waiterList.filter((ele, index, array) => {
        const timeCount = Number(ele.timeCount.split(":")[1]);
        const hours = Number(ele.timeCount.split(":")[0]);
        console.log("timeCount", timeCount)
        if (isNaN(timeCount)) {
      ...
      const yellowList = waiterList.filter((ele, index, array) => {
        const timeCount = Number(ele.timeCount.split(":")[1]);
        const hours = Number(ele.timeCount.split(":")[0]);
        console.log("timeCount", timeCount)
        if (isNaN(timeCount)) {
        ...
        <div className="container-fluid pt-0 pt-lg-4">
          <div className="parent-header-btns d-flex justify-content-between position-sticky">
            ...
            <div className="button-group mt-5 pt-0 pt-lg-3 ">
              ...
              <button
                onClick={() => handleButtonClick(waiterList, "All")}
                className={
                  activeButton === "All"
