...
export default function Check() {
  ...
  let {checkList  ,  } = useContext(OrderContext);
  let {t} = useTranslation();
  const [currentList, setCurrentList] = useState(checkList);
  ...
  // const updateLists = () => {
  //   const redList = checkList.filter((ele) => {
  ...
  //   const greenList = checkList.filter((ele) => {
  //     const specificTime = new Date(ele.createDate);
  //     const currentTime = new Date();
  //     const timePassedInSeconds = Math.floor(
  //       (currentTime.getTime() - specificTime.getTime()) / 1000
  ...
  //   const yellowList = checkList.filter((ele) => {
  //     const specificTime = new Date(ele.createDate);
  //     const currentTime = new Date();
  //     const timePassedInSeconds = Math.floor(
  //       (currentTime.getTime() - specificTime.getTime()) / 1000
  ...
  // };
  const updateLists = () => {
    const redList = checkList.filter((ele, index, array) => {
    ...
    const greenList = checkList.filter((ele, index, array) => {
      const timeCount = Number(ele.timeCount.split(":")[1]);
      const hours = Number(ele.timeCount.split(":")[0]);
      console.log("timeCount", timeCount)
      if (isNaN(timeCount)) {
    ...
    const yellowList = checkList.filter((ele, index, array) => {
      const timeCount = Number(ele.timeCount.split(":")[1]);
      const hours = Number(ele.timeCount.split(":")[0]);
      console.log("timeCount", timeCount)
      if (isNaN(timeCount)) {
      ...
      <div className="container-fluid pt-0 pt-lg-4">
        <div className="parent-header-btns d-flex justify-content-between position-sticky">
          ...
          <div className="button-group mt-5 pt-0 pt-lg-3 ">
            ...
            <button
              onClick={() => handleButtonClick(checkList, "All")}
              className={
                activeButton === "All"
