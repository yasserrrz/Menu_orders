...
export default function Order({ onStopStopwatch, setorderLength }) {
  let { serviceList, orderLength } = useContext(OrderContext);
  ...
  // const updateLists = () => {
  //   const redList = serviceList.filter((ele) => {
  ...
  //   const greenList = serviceList.filter((ele) => {
  //     const specificTime = new Date(ele.createDate);
  //     const currentTime = new Date();
  //     const timePassedInSeconds = Math.floor(
  //       (currentTime.getTime() - specificTime.getTime()) / 1000
  ...
  //   const yellowList = serviceList.filter((ele) => {
  //     const specificTime = new Date(ele.createDate);
  //     const currentTime = new Date();
  //     const timePassedInSeconds = Math.floor(
  //       (currentTime.getTime() - specificTime.getTime()) / 1000
  ...
  //     const currentTime = new Date();
  //     const timePassedInSeconds = Math.floor(
  //       (currentTime - specificTime) / 1000
  //     );
  //     const remainingMinutes = Math.floor(timePassedInSeconds / 60) % 60;
  //     const remainingHours = Math.floor(timePassedInSeconds / 3600);
  //     const timeThresholdInMinutes = 7; // Set your desired time threshold in minutes
  //     return remainingMinutes > timeThresholdInMinutes || remainingHours > 0;
  //   });
  ...
  //     return (
  //       remainingMinutes <= timeThresholdInMinutes && remainingHours === 0
  //     );
  //   });
  ...
  const updateLists = () => {
    const redList = serviceList.filter((ele, index, array) => {
    ...
    const greenList = serviceList.filter((ele, index, array) => {
      const timeCount = Number(ele.timeCount.split(":")[1]);
      const hours = Number(ele.timeCount.split(":")[0]);
      console.log("timeCount", timeCount)
      if (isNaN(timeCount)) {
    ...
    const yellowList = serviceList.filter((ele, index, array) => {
      const timeCount = Number(ele.timeCount.split(":")[1]);
      const hours = Number(ele.timeCount.split(":")[0]);
      console.log("timeCount", timeCount)
      if (isNaN(timeCount)) {
      ...
      <div className="container-fluid pt-0 pt-lg-4">
        <div className="parent-header-btns d-flex justify-content-between position-sticky">
          ...
          <div className="button-group mt-5 pt-0 pt-lg-3 ">
            ...
            <button
              onClick={() => handleButtonClick(serviceList, "All")}
              className={
                activeButton === "All"
